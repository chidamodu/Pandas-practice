...
#df1.columns.drop('Description',1).tolist(): It removes 'Description' in axis=1 and returns the labels['Resolution Letter', 'Action', 'Type'] in list type.
...
#df1.set_index: Chaining the above methods and setting index according to the new change by using set_index.

"""After the change, the same row1, with values of 'Description' unpacked, looks like:
